      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all pr-12"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-pink-500 via-purple-500 to-pink-600 text-white font-semibold rounded-xl hover:from-pink-600 hover:via-purple-600 hover:to-pink-700 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg"
            >
              {isLogin ? "Entrar" : "Criar Conta"}
            </button>
          </form>
