...
export type MuscleGroup = 'core' | 'posterior-chain' | 'anterior-chain' | 'lateral-chain' | 'upper-body' | 'lower-body' | 'peito' | 'costas' | 'ombro' | 'biceps' | 'triceps' | 'quadriceps' | 'gluteos' | 'lower-back' | 'upper-back' | 'hips';
export type Equipment = 'none' | 'resistance-band' | 'dumbbells' | 'barbell' | 'gym-machine' | 'yoga-mat' | 'kettlebell' | 'cable';
export type DifficultyLevel = 'beginner' | 'intermediate' | 'advanced';
export type PainArea = 'lower-back' | 'upper-back' | 'neck' | 'shoulder' | 'wrist' | 'elbow' | 'knee' | 'ankle' | 'hips';
...
export const EXERCISE_DATABASE: Exercise[] = [
  // ========== TIER 1 - CORE ==========
  {
    ...
    avoidIfPain: ['lower-back', 'shoulder'], benefits: ['Fortalece o core profundo', 'Melhora estabilidade'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'lower-back'], benefits: ['Fortalece oblíquos', 'Melhora estabilidade lateral'],
  ...
  // ========== TIER 1 - PEITO ==========
  {
    ...
    avoidIfPain: ['shoulder', 'lower-back'], benefits: ['Desenvolvimento geral do peitoral', 'Força de empurrar'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Ativação estabilizadora', 'Desenvolvimento simétrico'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Foco no peitoral superior'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Isolamento do peitoral', 'Melhora a conexão mente-músculo'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Força funcional', 'Ativação do core'],
  ...
  // ========== TIER 1 - COSTAS ==========
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Desenvolvimento da largura das costas', 'Base para barra fixa'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Força superior do corpo', 'Melhor exercício para dorsais'],
  ...
  // ========== TIER 1 - PERNAS (QUADRÍCEPS E GLÚTEOS) ==========
  {
    ...
    avoidIfPain: ['knee', 'lower-back'], benefits: ['Força e hipertrofia de pernas', 'Alto gasto calórico'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Ensina o padrão correto de agachamento', 'Fortalece o core'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'lower-back'], benefits: ['Alternativa segura ao agachamento', 'Foco na carga'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Trabalho unilateral', 'Melhora equilíbrio e estabilidade'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Isolamento total do quadríceps', 'Ótimo para finalizar o treino'],
  ...
  // ========== TIER 1 - OMBROS ==========
  {
    ...
    avoidIfPain: ['shoulder', 'lower-back'], benefits: ['Força total da parte superior do corpo', 'Estabilidade do core'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Mais seguro para a lombar que a versão em pé', 'Desenvolvimento dos ombros'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Isolamento da cabeça medial do deltoide', 'Aparência de ombros mais largos'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Foco na cabeça anterior do deltoide'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Saúde dos ombros', 'Fortalece o manguito rotador e deltoide posterior', 'Corrige postura'],
    ...
    // ========== TIER 1 - BÍCEPS ==========
  {
    ...
    avoidIfPain: ['shoulder', 'lower-back'], benefits: ['Desenvolvimento da massa do bíceps'],
  ...
  // ========== TIER 1 - TRÍCEPS ==========
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Isolamento eficaz do tríceps', 'Seguro e fácil de aprender'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Maior pico de contração', 'Foco na cabeça lateral do tríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Excelente alongamento e contração da cabeça longa do tríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Exercício com peso corporal eficaz para tríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Permite usar cargas altas para o tríceps', 'Exercício composto'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'hips'], benefits: ['Combate os efeitos de ficar sentado', 'Alivia dor lombar'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Descompressão da coluna', 'Melhora força da pegada', 'Aumenta espaço na articulação do ombro'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'hips', 'lower-back'], benefits: ['Mobilidade de quadril, torácica e tornozelo em um só exercício'],
  ...
  // ========== TIER 1 - AERÓBICOS / CARDIO ==========
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Baixo impacto nas articulações', 'Melhora da capacidade cardiovascular'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'hips'], benefits: ['Trabalho de corpo inteiro com baixo impacto'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'hips', 'lower-back'], benefits: ['Alto gasto calórico', 'Melhora da saúde óssea'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Foco em glúteos e quadríceps', 'Alto gasto calórico'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Isolamento da porção clavicular do peito'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Isolamento seguro e eficaz para o peitoral', 'Fácil de executar'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Trabalha deltoides mediais e trapézio'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Foco no deltoide posterior e romboides', 'Excelente para postura'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'hips'], benefits: ['Maior ativação dos glúteos e parte interna da coxa'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Excelente exercício para a cabeça longa do tríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Isolamento da dorsal', 'Melhora a conexão mente-músculo com as costas'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Excelente para hipertrofia unilateral', 'Desafia o equilíbrio e a estabilidade'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'lower-back'], benefits: ['Segurança para a coluna', 'Foco intenso no quadríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Tensão contínua no deltoide medial', 'Ótimo para isolamento'],
  ...
  },
  {
    ...
    avoidIfPain: ['neck', 'shoulder'], benefits: ['Fortalecimento do trapézio superior'],
  ...
  },
  {
    ...
    avoidIfPain: ['wrist'], benefits: ['Fortalecimento dos extensores do punho e braquiorradial'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Foco na cabeça longa do tríceps', 'Grande amplitude de movimento'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Ênfase diferente nos músculos das costas e bíceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Expansão da caixa torácica', 'Trabalha músculos antagonistas (peito e costas)'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'shoulder', 'wrist'], benefits: ['Maior ativação do quadríceps e core', 'Menos compressão na coluna que o agachamento tradicional'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Foco na parte superior do peitoral'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Excelente para o desenvolvimento da parte inferior do peito e tríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['lower-back', 'shoulder'], benefits: ['Fortalecimento extremo de core (anti-extensão)'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Máxima ativação do tríceps com peso corporal'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'lower-back'], benefits: ['Desenvolvimento de potência', 'Aumento da frequência cardíaca'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Trabalha as três cabeças do deltoide em um único movimento'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Menor estresse nos joelhos', 'Foco nos glúteos'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Trabalha a estabilidade anti-rotacional do core'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Trabalho dinâmico para as pernas', 'Melhora coordenação e equilíbrio'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Permite usar cargas altas para panturrilha com segurança'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Excelente construtor de bíceps e costas'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Fortalecimento isométrico do quadríceps', 'Resistência muscular'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Isolamento e pico de contração do tríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Fortalece toda a cadeia posterior', 'Contrapõe a postura sentada'],
  ...
  },
  {
    ...
    commonMistakes: ['Lombar cedendo'],
    avoidIfPain: ['shoulder'], benefits: ['Versão mais fácil da flexão', 'Ótimo para iniciantes'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Tensão constante no peitoral', 'Foco na parte inferior e interna do peito'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'lower-back'], benefits: ['Ênfase diferente no trapézio', 'Melhora a postura dos ombros'],
  ...
  },
  {
    ...
    avoidIfPain: ['lower-back', 'shoulder'], benefits: ['Força máxima para o abdômen e flexores do quadril'],
  ...
  },
  {
    ...
    avoidIfPain: ['wrist'], benefits: ['Isolamento do bíceps com menor estresse nos punhos'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Tensão contínua no tríceps', 'Ótimo para pico de contração'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Isolamento extremo do quadríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['lower-back', 'knee'], benefits: ['Variação do leg press com diferente curva de resistência'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Desenvolvimento de força unilateral', 'Grande desafio de estabilidade'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'lower-back'], benefits: ['Desenvolve força, mobilidade e equilíbrio unilaterais'],
  ...
  },
  {
    ...
    commonMistakes: ['Dobrar o quadril'],
    avoidIfPain: ['knee'], benefits: ['Excelente para a saúde do joelho e fortalecimento excêntrico do quadríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Um dos melhores exercícios para prevenir lesões de posterior de coxa', 'Força excêntrica'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'shoulder'], benefits: ['Aquecimento cardiovascular rápido e eficaz'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'lower-back', 'shoulder', 'wrist'], benefits: ['Exercício de corpo inteiro de alta intensidade', 'Condicionamento metabólico'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Menor estresse nos ombros e punhos', 'Boa combinação de força de costas e bíceps'],
  ...
  // ========== TIER 1 - CONTINUAÇÃO 3 ==========
  {
    ...
    avoidIfPain: ['lower-back', 'knee', 'shoulder'], benefits: ['Ativação massiva do core', 'Fortalece a postura da parte superior das costas'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Fortalecimento do manguito rotador', 'Prevenção de lesões no ombro'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Alivia a tensão no peitoral', 'Ajuda a corrigir ombros caídos para frente'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'hips'], benefits: ['Alonga o piriforme e outros músculos profundos do glúteo', 'Alivia dor ciática'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Desenvolvimento de potência e explosão'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Exercício de ombro mais seguro e funcional', 'Menos estresse na articulação'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Fortalece quadríceps e adutores simultaneamente', 'Melhora a estabilidade do joelho'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Variação da remada alta com maior liberdade de movimento'],
  ...
  },
  {
    ...
    avoidIfPain: ['lower-back', 'shoulder'], benefits: ['Intensidade muito maior para o reto abdominal e core'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Corrige desequilíbrios de força nas costas', 'Melhor conexão mente-músculo'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Aquecimento dinâmico', 'Eleva a frequência cardíaca rapidamente'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Aumenta a flexibilidade do quadríceps'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Excelente exercício de peso corporal para as costas', 'Precursor da barra fixa'],
  ...
  },
  {
    ...
    avoidIfPain: ['wrist', 'shoulder'], benefits: ['Estabilidade do core e ombros', 'Coordenação e força funcional'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'lower-back'], benefits: ['Desenvolve força a partir da inércia zero', 'Melhora o controle e a estabilidade no agachamento'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Aumenta a força na parte inferior do movimento', 'Melhora o controle'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Combina estabilidade de prancha com mobilidade torácica e força de oblíquos'],
  ...
  },
  {
    ...
    commonMistakes: ['Usar apenas os braços', 'Ficar com o corpo muito reto'],
    avoidIfPain: ['shoulder', 'lower-back'], benefits: ['Cardio de alta intensidade e baixo impacto', 'Força e resistência de membros superiores'],
  ...
  },
  {
    ...
    avoidIfPain: ['hips', 'knee'], benefits: ['Alongamento acessível para o piriforme', 'Pode ser feito em qualquer lugar'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'lower-back'], benefits: ['Desenvolvimento de potência de corpo inteiro', 'Precursor para movimentos olímpicos'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Potência, agilidade e coordenação'],
    ...
    // ========== TIER 1 - PARTE FINAL (151-180) ==========
  {
    ...
    avoidIfPain: ['knee', 'lower-back'], benefits: ['Ótima variação para quem tem dificuldade com a mobilidade do agachamento tradicional'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Conexão mente-músculo incrível para o peitoral', 'Tensão constante'],
  ...
  },
  {
    ...
    avoidIfPain: ['lower-back', 'shoulder'], benefits: ['Fortalece deltoide posterior e romboides', 'Crucial para a saúde dos ombros e postura'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Permite sobrecarga no tríceps com uma mecânica única'],
  ...
  },
  {
    ...
    avoidIfPain: ['wrist', 'shoulder'], benefits: ['Cardio e core combinados', 'Alta intensidade'],
  ...
  },
  {
    ...
    avoidIfPain: ['hips', 'knee'], benefits: ['Melhora a rotação interna e externa do quadril', 'Libera a tensão na articulação'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee', 'hips'], benefits: ['Excelente exercício de ativação para o glúteo médio', 'Prevenção de lesões no joelho'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'wrist'], benefits: ['Saúde do ombro', 'Força de pegada', 'Estabilidade do manguito rotador'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder', 'lower-back', 'knee'], benefits: ['Força de corpo inteiro, estabilidade, mobilidade e coordenação em um só exercício'],
  ...
  },
  {
    ...
    avoidIfPain: ['wrist'], benefits: ['Fortalecimento dos flexores do punho', 'Melhora a força de pegada'],
  ...
  },
  {
    ...
    cues: ['Isole o movimento no punho', 'Use um peso leve'],
    commonMistakes: ['Usar o braço para ajudar'],
    avoidIfPain: ['wrist'], benefits: ['Fortalecimento dos extensores do punho', 'Equilibra a força do antebraço'],
  ...
  },
  {
    ...
    commonMistakes: ['Balançar o corpo', 'Usar muito peso'],
    avoidIfPain: ['wrist', 'shoulder', 'lower-back'], benefits: ['Combina estabilidade de core com força de puxada', 'Exercício de alta eficiência'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Abre a coluna torácica', 'Alonga a dorsal e o peitoral'],
  ...
  },
  {
    ...
    avoidIfPain: ['lower-back', 'shoulder'], benefits: ['Exercício intenso para a parte inferior do abdômen'],
  ...
  },
  {
    ...
    avoidIfPain: ['lower-back', 'wrist'], benefits: ['Estabilidade do core e da coluna', 'Coordenação', 'Fortalecimento de glúteos e eretores'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Resistência muscular', 'Fortalecimento de tendões e ligamentos'],
  ...
  },
  {
    ...
    avoidIfPain: ['wrist', 'shoulder'], benefits: ['Fortalecimento do core e estabilidade dos ombros'],
  ...
  },
  {
    ...
    avoidIfPain: ['shoulder'], benefits: ['Aumenta a flexibilidade do tríceps', 'Melhora a mobilidade do ombro'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Aumenta a dorsiflexão', 'Essencial para um bom agachamento', 'Previne lesões no joelho'],
  ...
  },
  {
    ...
    avoidIfPain: ['knee'], benefits: ['Alongamento suave para a lombar e quadris', 'Posição de descanso e relaxamento'],
